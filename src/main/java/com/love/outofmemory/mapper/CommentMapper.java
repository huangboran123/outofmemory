...
public interface CommentMapper {
    ...
    @Select("select o_comment.id,critic_id,comment_time,comment_content,image,username from o_comment inner join o_user on o_comment.critic_id=o_user.id   where blog_id=#{blogId} order by comment_time desc limit #{start},#{counts} ")
